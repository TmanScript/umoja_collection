...
// Link with motion capabilities so dashboard cards can animate in and lift on hover.
    ...
    <div className="max-w-4xl mx-auto">
      ...
      {isGeneralViewer ? (
        ...
        <div className="grid md:grid-cols-2 gap-8">
            {/* Statistics Card */}
            <MotionLink {...cardMotion(0)} to="/stats" className="group bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-xl hover:border-purple-300 transition-shadow duration-300 text-center">
            ...
            {/* History Card */}
             <MotionLink {...cardMotion(0.08)} to="/history" className="group bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-xl hover:border-blue-300 transition-shadow duration-300 text-center">
        ...
        <div className="grid md:grid-cols-2 gap-8">
            {/* Swap Card */}
            <MotionLink {...cardMotion(0)} to="/swap" className="group bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-xl hover:border-pink-300 transition-shadow duration-300 text-center">
            ...
            {/* Collection Card */}
            <MotionLink {...cardMotion(0.08)} to="/collection" className="group bg-white rounded-2xl shadow-sm border border-gray-200 p-8 hover:shadow-xl hover:border-cyan-300 transition-shadow duration-300 text-center">
